  ...
  var i = {},
      ...
      if (!window.slimScrollStylesApplied) {
        ...
        var slim = "[" + l + "]",
          ...
          S =
            ...
            ";bottom:0px" +
            imp +
            ";right:0px;left:auto;width:5px;cursor:pointer" +
            imp +
            ";padding-right:0px" +
            imp +
            ";",
        ...
        head.insertBefore(
          style,
          head.hasChildNodes() ? head.childNodes[0] : null
        );
    ...
    init = function () {
      ...
      if (scrollBarVisible()) {
        ...
        q.a = payload.scrollBarContainerSpecialClass
          ? " " + payload.scrollBarContainerSpecialClass
          : "";
